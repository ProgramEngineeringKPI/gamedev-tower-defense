...
{
    using View = mediation.impl.View;
    ...
    public class Injector : IInjector
	{
		...
		public object Inject(object target, bool attemptConstructorInjection)
		{
			...
			failIf(target == null, $"Attempt to inject into null instance of \"{nameof(target)}\". I.e. you have tried to do binder.Inject(null)", InjectionExceptionType.NULL_TARGET);
		...
		private void postInject(object target, IReflectedClass reflection)
		{
            ...
            if (view != null)
		    {
		        if (view.isGoingToBeDestroyed)
		        {
                    Debug.Log("Object destroyed before postinject");
		            return;
		        }
		    }
